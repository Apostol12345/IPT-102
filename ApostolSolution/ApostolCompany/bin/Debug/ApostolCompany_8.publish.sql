...
CREATE TABLE [dbo].[DEPARTMENT] (
    ...
    CONSTRAINT [UK_DEPARTMENT_Dname] UNIQUE NONCLUSTERED ([Dname] ASC)
);
...
CREATE TABLE [dbo].[DEPENDENT] (
    ...
    CONSTRAINT [PK_DEPARTMENT_Dname] PRIMARY KEY CLUSTERED ([Essn] ASC, [Dname] ASC)
);
...
CREATE TABLE [dbo].[DEPT_LOCATION] (
    ...
    CONSTRAINT [PK_DEPT_LOCATION_Dnumber] PRIMARY KEY CLUSTERED ([Dnumber] ASC)
);


GO
PRINT N'Creating Index [dbo].[DEPT_LOCATION].[IX_DEPT_LOCATION_Dlocation]...';


GO
CREATE NONCLUSTERED INDEX [IX_DEPT_LOCATION_Dlocation]
...
CREATE NONCLUSTERED INDEX [IX_EMPLOYEE_Name]
    ON [dbo].[EMPLOYEE]([Fname] ASC, [Lname] ASC, [Minit] ASC);
...
CREATE TABLE [dbo].[PROJECT] (
    ...
    [Dnum]      INT          NOT NULL,
    CONSTRAINT [PK_PROJECT_Pnumber] PRIMARY KEY CLUSTERED ([Plocation] ASC),
    CONSTRAINT [UX_PROJECT_Pname] UNIQUE NONCLUSTERED ([Pname] ASC)
);
...
END
GO
PRINT N'Creating Procedure [dbo].[PROJECT_READ]...';
